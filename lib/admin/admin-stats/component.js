  ...
  render () {
    ...
    return (
      <div>
        <h2>Stats</h2>
        <hr />
        <p barclassName='h3'><i className="bar-chart"></i> Usuarios</p>
        ...
        <p barclassName='h3'><i className="bar-chart"></i> Contenido</p>
        <table className='table table-bordered'>
          <tbody>
            <tr>
              <th>Proyectos</th>
        ...
        <p barclassName='h3'><i className="bar-chart"></i> Agenda</p>
        <table className='table table-bordered'>
          <tbody>
            <tr>
