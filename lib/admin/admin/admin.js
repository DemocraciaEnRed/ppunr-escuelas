...
import AdminEscuelas from '../admin-escuelas/view'
...
page(
  urlBuilder.for('admin.escuelas'),
  (ctx) => {
    const escuelaSettings = new AdminEscuelas(ctx.forum)
    escuelaSettings.replace('.admin-content')
