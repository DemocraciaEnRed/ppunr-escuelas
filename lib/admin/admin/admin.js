...
import AdminEscuelas from '../admin-escuelas/component'
...
page(
  ...
  (ctx) => {
    ...
    render(<AdminPadron forum={ctx.forum} escuelas={ctx.uniqAttrs.escuelas} claustros={ctx.uniqAttrs.claustros} />, document.querySelector('.admin-content'))
})
...
page(urlBuilder.for('admin.escuelas'), (ctx) => {
  ctx.sidebar.set('escuelas')
  render(<AdminEscuelas forum={ctx.forum} />, document.querySelector('.admin-content'))
})
