...
export default class BuscarDNI extends Component {
  ...
  showEscuelaData (escuela) {
    return (
      <div className="" key={`escuela-${escuela._id}`}>
        <table className="table table-bordered">
          <tbody>
            <tr>
              <th>Nombre</th>
            ...
            <tr>
              <th>Abreviación</th>
              <td>{escuela.abreviacion}</td>
            </tr>
            <tr>
              <th>Mail Padron</th>
              <td>{escuela.mailPadron}</td>
            </tr>
            <tr>
              <th>ID</th>
              <td><small>{escuela._id}</small></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        { this.state.result &&
          ...
          <div className="row">
            <div className="col-md-6">
              <p className='h4'><b>Escuelas</b></p>
              { this.state.result.escuelas.map((escuela, i) => this.showEscuelaData(escuela)) }
            </div>
