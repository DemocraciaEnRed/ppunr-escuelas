  ...
  render () {
    ...
    return (
      ...
      <div id='buscar-dni-component'>
        <p className='h3'><i className='icon-copy' /> Agregar DNI(s) masivamente al padrón</p>
        <p>Puede agregar varios DNI(s) de una escuela al padrón.<br /><b>Tenga cuidado en usar esta función ya que las inserciones al padrón pueden ser irreversibles</b> </p>
