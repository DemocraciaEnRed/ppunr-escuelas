...
export default class ProfileForm extends FormView {
  ...
  constructor () {
    super(template)
    this.configForum;
    forumStore.findOneByName('proyectos').then(this.showProyectistas.bind(this)).catch(err=>console.log(err))
  ...
  switchOn () {
    ...
    this.select = this.find('select#proyectista')[0]
