              ...
              <FormAsync
                ...
                { configForum && configForum.mostrarFormulariosProyectistas &&
                  <div className='form-group'>
                    ...
                    <p className="help-text"><i className="icon-info icon-large"></i> <u>Ser proyectista</u> implica transformar las ideas en proyectos. Podes informarte más acerca de que es ser proyectista en la sección de <Link href="/acerca-de">Información</Link></p>
                  </div>
                }
                <div className='form-group'>
