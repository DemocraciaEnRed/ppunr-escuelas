    ...
    if (padron){
      ...
      api.escuela.get(profile.escuela).then(escuela => {
        ...
        return res.status(200).json({
          error: `Tu DNI no se encuentra en el padrón. Revisá si tu DNI es el correcto o completá <a href="https://docs.google.com/forms/d/e/1FAIpQLScc-ipTeJQxzwE-l8wWT3RVjsYPj-fmIy7Z7yggsFrbyKVjZw/viewform" target="_blank">este formulario</a> con tus datos`
        })
      })
  })
})
