    ...
    if (padron){
      ...
      api.escuela.get(profile.escuela).then(escuela => {
        ...
        return res.status(200).json({
          error: `Tu DNI no se encuentra en el padrón. Revisá si tu DNI es el correcto o completá <a href="https://docs.google.com/forms/d/e/1FAIpQLSeieLOtdkrIpYQIPo5LJpDEZZU-27Zfo2FniG7zkde4XH-flw/viewform" target="_blank">este formulario</a> con tus datos`
        })
      })
  })
})
